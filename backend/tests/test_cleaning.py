...
(CLEANING -> CANONICALIZING, observational GETs, 409/404/410, terminal
...
def test_trim_fixture_settles_at_canonicalizing(
...
def test_unreadable_report_with_pointer_returns_stored_state(
    ...
    assert result is not None and result.state == "CANONICALIZING"
